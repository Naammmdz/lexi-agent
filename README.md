...
📄 **Giám khảo / tái hiện:** [docs/HUONG_DAN_GIAM_KHAO.md](docs/HUONG_DAN_GIAM_KHAO.md) ← **đọc file này**  
...
| File | Mục đích |
|------|----------|
| **[docs/HUONG_DAN_GIAM_KHAO.md](docs/HUONG_DAN_GIAM_KHAO.md)** | **Tái hiện 2000 câu — một file, 10 bước** |
| [docs/THUYET_MINH_SAN_PHAM.md](docs/THUYET_MINH_SAN_PHAM.md) | Checklist nộp bài |
| [docs/04_HUONG_DAN_TAI_HIEN_2000_CAU.md](docs/04_HUONG_DAN_TAI_HIEN_2000_CAU.md) | Chi tiết kỹ thuật (tham khảo) |
| [docs/00_GIOI_THIEU.md](docs/00_GIOI_THIEU.md) | Giới thiệu sản phẩm |
| [docs/01_MO_TA_DU_LIEU.md](docs/01_MO_TA_DU_LIEU.md) | Dữ liệu, corpus, index |
| [docs/02_MO_HINH.md](docs/02_MO_HINH.md) | Mô hình |
| [docs/03_MA_NGUON_VA_CAU_HINH.md](docs/03_MA_NGUON_VA_CAU_HINH.md) | Mã nguồn |
...
> **Giám khảo:** làm theo **[docs/HUONG_DAN_GIAM_KHAO.md](docs/HUONG_DAN_GIAM_KHAO.md)** (10 bước, không cần đọc thêm file khác). Phần dưới là tóm tắt.
...
Tải hai folder `data` và `index`, copy vào thư mục `lexi-agent/`. Chi tiết: [docs/HUONG_DAN_GIAM_KHAO.md](docs/HUONG_DAN_GIAM_KHAO.md) bước 3.
...
export ENABLE_RERANKING=1    # bắt buộc — log phải có "Reranker model loaded successfully"
bash scripts/run_full_2000_pipeline.sh
```

> **Cảnh báo:** Phải bật `ENABLE_RERANKING=1` và chạy **đủ** quy trình (không bỏ bước tìm 2000 câu). Xem [docs/HUONG_DAN_GIAM_KHAO.md](docs/HUONG_DAN_GIAM_KHAO.md) bước 8.

**Windows:** Git Bash (lệnh trên) hoặc PowerShell — xem [docs/HUONG_DAN_GIAM_KHAO.md](docs/HUONG_DAN_GIAM_KHAO.md) bước 8.

**Output:** `submission.zip` + `submission_qa.zip` (mỗi file **2000 dòng**).

Hướng dẫn đầy đủ: [docs/HUONG_DAN_GIAM_KHAO.md](docs/HUONG_DAN_GIAM_KHAO.md)
