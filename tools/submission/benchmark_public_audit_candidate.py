"""Small public-set audit benchmark for rows with strong manual evidence."""
...
CASES: list[dict[str, Any]] = [
    {
        "id": 11,
        "note": "SME definition sample from organizer includes Law 04 Articles 4, 5 and Decree 80 Article 5.",
        "gold": [("04/2017/QH14", "4"), ("04/2017/QH14", "5"), ("80/2021/NĐ-CP", "5")],
    },
    {
        "id": 21,
        "note": "Question asks eligible subjects for direct startup training; top retrieved article text is TT05 Article 1 scope and subjects.",
        "gold": [("05/2019/TT-BKHĐT", "1")],
    },
    {
        "id": 43,
        "note": "Corpus article containing the condition is Tax Administration Law Article 150, which adds Accounting Law Article 70a.",
        "gold": [("38/2019/QH14", "150")],
    },
]
...
def main() -> None:
    ...
    parser.add_argument("paths", nargs="*", default=[
        ...
        "submission_variants/submission_domain_repair_v31_public_precision_fix.zip",
    ])
    parser.add_argument("--output", default="submission_variants/local_benchmark/public_audit_benchmark_v31.json")
