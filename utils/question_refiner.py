...
class VietnameseLegalQuestionRefiner:
    ...
    def __init__(self):
        ...
        if Config.USE_LOCAL_LLM:
            print("⚠️ Skipping Qwen3-4B for question refinement (Bypass mode to save RAM)")
            self.llm = None
...
Chỉ trả về JSON, không có text khác:""",
    ...
    def _initialize_qwen_model(self):
        """Initialize Qwen3-4B model for question refinement"""
        try:
            model_name = Config.MODEL_REFINE
            print(f"Loading Qwen3-4B for question refinement from {model_name}...")
            ...
            print(f"Error initializing Qwen model for question refinement: {e}")
            return None
