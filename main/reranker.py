...
class DocumentReranker:
    ...
    def _initialize_model(self):
        ...
        try:
            import torch
            preferred = getattr(Config, "RERANKER_DEVICE", "") or os.getenv("RERANKER_DEVICE", "")
            if preferred:
                device = preferred
            else:
                device = (
            ...
            print(
                ...
                f"(max_length={self.max_length}) on {device}"
            )
            ...
            try:
                ...
                print(f"Trying fallback model: {fallback_model} on {device}")
                self.model = CrossEncoder(fallback_model, max_length=512, device=device)
    ...
    def rerank_documents(self, 
        ...
        try:
            ...
            for doc in documents:
                ...
                # Token truncation is handled by CrossEncoder max_length.
            ...
            # Get relevance scores from cross-encoder (small batches for large models).
